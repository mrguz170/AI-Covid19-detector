...
input_path_b = 'COVID19_VIRUS_DETECTOR/xray_dataset/'
...
def init():
    ...
    input_path_d = 'COVID19_VIRUS_DETECTOR/xray_dataset_covid19/'
    ...
    return model_covid19PneumoniaDetector, graph, sess
